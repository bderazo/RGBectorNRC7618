...
public class SpringSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/tipoUsuario/**").permitAll()
				.antMatchers("/h2-console/**").permitAll()
				.antMatchers("/urlsInspiracion/**").permitAll()
				.antMatchers("/trabajosAceptados/**").permitAll()
				.antMatchers("/tipoUsuario/**").permitAll()
				.antMatchers("/tipoDisenio/**").permitAll()
				.antMatchers("/redes/**").permitAll()
				.antMatchers("/propuestas/**").permitAll()
				.antMatchers("/perfiles/**").permitAll()
				.antMatchers("/pedidos/**").permitAll()
				.antMatchers("/pagos/**").permitAll()
				.antMatchers("/imagenesPropuesta/**").permitAll()
				.antMatchers("/etiquetasTipoDisenio/**").permitAll()
